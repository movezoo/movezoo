  ...
  const handleNicknameChange = async () => {
    try {
      ...
      if (nickname === newNickName) {
        alert('현재 닉네임과 같은 닉네임입니다. 다른 닉네임을 입력해주세요.');
        return;
      }
...
//       // 현재 닉네임과 새로운 닉네임이 같은 경우
//       if (nickname === newNickName) {
//         alert('현재 닉네임과 같은 닉네임입니다. 다른 닉네임을 입력해주세요.');
//         return;
//       }
  
//       const response = await axios.patch('https://i10e204.p.ssafy.io/api/user/nickname', {userEmail, nickname: newNickName}, {
//         withCredentials: true,
//       });
